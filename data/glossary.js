 ...
 * count는 누적 등장 횟수, firstSeen은 처음 실린 브리핑 날짜.
 */
...
SAB.glossary = [
  {
    ...
    firstSeen: '2026-08-12', count: 19
  },
  {
    id: 'context-window',
    term: { ko: '컨텍스트 창', en: 'Context window' },
    definition: {
    ...
    firstSeen: '2026-08-12', count: 14
  },
  {
    id: 'inference',
    term: { ko: '추론', en: 'Inference' },
    definition: {
  ...
  },
  {
    ...
    firstSeen: '2026-08-13', count: 11
  },
  {
    id: 'open-weights',
    term: { ko: '공개 가중치', en: 'Open weights' },
    definition: {
    ...
    firstSeen: '2026-08-14', count: 9
  },
  {
    id: 'moe',
    term: { ko: '전문가 혼합(MoE)', en: 'Mixture of Experts' },
    definition: {
      ko: '모델 안에 여러 개의 부분망을 두고 입력마다 그중 일부만 켜서 계산하는 구조. 전체 파라미터는 크게 유지하면서 한 번의 추론에 드는 연산은 줄인다.',
      en: 'An architecture that holds many sub-networks and activates only a few per input, keeping total parameters large while cutting the compute spent on each inference.'
    },
    firstSeen: '2026-08-17', count: 7
  },
  {
    id: 'distillation',
    term: { ko: '증류', en: 'Distillation' },
    definition: {
      ko: '큰 모델의 출력을 교재 삼아 작은 모델을 학습시켜 성능은 최대한 남기고 크기를 줄이는 기법. 온디바이스 모델을 만드는 주된 방법이다.',
      en: 'Training a small model on a large model’s outputs to retain most of its quality at a fraction of the size — the standard route to on-device models.'
    },
    firstSeen: '2026-08-18', count: 6
  },
  {
    id: 'fine-tuning',
    term: { ko: '미세조정', en: 'Fine-tuning' },
    definition: {
    ...
    firstSeen: '2026-08-18', count: 8
  },
  {
    id: 'rag',
    term: { ko: '검색 증강 생성(RAG)', en: 'Retrieval-augmented generation' },
    definition: {
    ...
    firstSeen: '2026-08-19', count: 10
  },
  {
    id: 'eval',
    term: { ko: '평가 벤치마크', en: 'Evaluation benchmark' },
    definition: {
    ...
    firstSeen: '2026-08-20', count: 12
  },
  {
    id: 'alignment',
    term: { ko: '정렬', en: 'Alignment' },
    definition: {
    ...
    firstSeen: '2026-08-21', count: 9
  },
  {
    id: 'red-teaming',
    term: { ko: '레드팀', en: 'Red teaming' },
    definition: {
    ...
    firstSeen: '2026-08-21', count: 7
  },
  {
    id: 'guardrails',
    term: { ko: '가드레일', en: 'Guardrails' },
    definition: {
    ...
    firstSeen: '2026-08-22', count: 8
  },
  {
    id: 'sovereign-ai',
    term: { ko: '소버린 AI', en: 'Sovereign AI' },
    definition: {
    ...
    firstSeen: '2026-08-24', count: 6
  },
  {
    id: 'hbm',
    term: { ko: '고대역폭 메모리(HBM)', en: 'High-bandwidth memory' },
    definition: {
    ...
    firstSeen: '2026-08-25', count: 5
  },
  {
    id: 'pue',
    term: { ko: '전력사용효율(PUE)', en: 'Power usage effectiveness' },
    definition: {
